...
fn client_handshake_rejects_incompatible_version() {
    ...
    assert_eq!(version, 11, "server should report its version 11");
    assert!(
        error.is_some(),
