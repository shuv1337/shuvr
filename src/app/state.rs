...
pub struct AppState {
    ...
    /// Capture mouse input for Shuvr's own mouse UI. When false, Shuvr only
...
impl AppState {
    ...
    pub fn test_new() -> Self {
        Self {
            ...
            worktree_directory: std::path::PathBuf::from("/tmp/shuvr-worktrees"),
            ...
            update_install_command: "shuvr update".into(),
