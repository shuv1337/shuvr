...
pub(crate) use self::{
    modal::{
        handle_confirm_close_key, handle_context_menu_key, handle_demo_tour_key,
        handle_global_menu_key, handle_keybind_help_key, handle_navigator_key, handle_rename_key,
        handle_resize_key,
    },
        ...
        match self.state.mode {
            ...
            _ => {
                ...
                match self.state.mode {
                    ...
                    Mode::DemoTour => handle_demo_tour_key(&mut self.state, key_event),
