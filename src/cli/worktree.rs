...
fn worktree_list(args: &[String]) -> std::io::Result<i32> {
    ...
    if workspace_id.is_some() && cwd.is_some() {
        eprintln!("usage: shuvr worktree list [--workspace ID | --cwd PATH] [--json]");
        return Ok(2);
    }
...
fn worktree_create(args: &[String]) -> std::io::Result<i32> {
    ...
    if workspace_id.is_some() && cwd.is_some() {
        eprintln!(
            "usage: shuvr worktree create [--workspace ID | --cwd PATH] [--branch NAME] [--base REF] [--path PATH] [--label TEXT] [--focus] [--no-focus] [--json]"
        );
        return Ok(2);
    }
...
fn worktree_open(args: &[String]) -> std::io::Result<i32> {
    ...
    if workspace_id.is_some() && cwd.is_some() {
        eprintln!(
            "usage: shuvr worktree open [--workspace ID | --cwd PATH] (--path PATH | --branch NAME) [--label TEXT] [--focus] [--no-focus] [--json]"
        );
        return Ok(2);
    }
...
fn worktree_remove(args: &[String]) -> std::io::Result<i32> {
    ...
    let Some(workspace_id) = workspace_id else {
        eprintln!("usage: shuvr worktree remove --workspace ID [--force] [--json]");
        return Ok(2);
    };
...
fn print_worktree_help() {
    eprintln!("shuvr worktree commands:");
    eprintln!("  shuvr worktree list [--workspace ID | --cwd PATH] [--json]");
    eprintln!(
        "  shuvr worktree create [--workspace ID | --cwd PATH] [--branch NAME] [--base REF] [--path PATH] [--label TEXT] [--focus] [--no-focus] [--json]"
    );
    eprintln!(
        "  shuvr worktree open [--workspace ID | --cwd PATH] (--path PATH | --branch NAME) [--label TEXT] [--focus] [--no-focus] [--json]"
    );
    eprintln!("  shuvr worktree remove --workspace ID [--force] [--json]");
}
