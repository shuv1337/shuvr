"""Hermes plugin installed by Shuvr to report agent lifecycle state."""

# SHUVR_INTEGRATION_ID=hermes
...
_SOURCE = "shuvr:hermes"
_AGENT = "hermes"


def _base_params() -> tuple[str, str] | None:
    if os.environ.get("SHUVR_ENV") != "1":
        return None
    pane_id = os.environ.get("SHUVR_PANE_ID", "").strip()
    socket_path = os.environ.get("SHUVR_SOCKET_PATH", "").strip()
