            ...
            result: ResponseResult::WorktreeCreated {
                workspace: WorkspaceInfo {
                    ...
                    worktree: Some(WorkspaceWorktreeInfo {
                        repo_key: "/repo/shuvr/.git".into(),
                        repo_name: "shuvr".into(),
                        repo_root: "/repo/shuvr".into(),
                        checkout_path: "/worktrees/shuvr/worktree-api".into(),
                ...
                root_pane: PaneInfo {
                    ...
                    tab_id: "w_1:1".into(),
                    focused: true,
                    cwd: Some("/worktrees/shuvr/worktree-api".into()),
                    foreground_cwd: None,
                    label: None,
                    agent: None,
                    title: None,
                ...
                worktree: WorktreeInfo {
                    path: "/worktrees/shuvr/worktree-api".into(),
                    branch: Some("worktree/api".into()),
                    is_bare: false,
                    is_detached: false,
                    is_prunable: false,
